...
$subject ="Новая заявка с сайта m1ghty07";
...
$header .= "From: Новая заявка <dulchenko.su@gmail.com>\n\n";	
$mail = mail("dulchenko.su@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
